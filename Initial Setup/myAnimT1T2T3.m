...
//	Empty_.backgroundColor = [[UIColor colorWithRed:0.0 green:1.0 blue:0.0  alpha:0.85] CGColor];
	...
	t1 = CGAffineTransformMakeTranslation(0.00, -80.00);
	t2 = CGAffineTransformRotate(t1,  0.0);
	t3 = CGAffineTransformScale(t2, 1.00, 1.00);
	head.transform = CATransform3DMakeAffineTransform(t3);
	...
	t1 = CGAffineTransformMakeTranslation(10.00, -231.975098);
	t2 = CGAffineTransformRotate(t1,  1.221730);
	t3 = CGAffineTransformScale(t2, 1.00, 1.00);
	leftForArm.transform = CATransform3DMakeAffineTransform(t3);
//	leftForArm.transform = CATransform3DMakeAffineTransform(CGAffineTransformScale(CGAffineTransformRotate(CGAffineTransformMakeTranslation(10.00, -231.975098), 1.221730), 1.00, 1.00));
	...
	t1 = CGAffineTransformMakeTranslation(70.00, 0.35);
	t2 = CGAffineTransformRotate(t1,  M_PI);
	t3 = CGAffineTransformScale(t2, 1.00, 1.00);
	leftArm.transform = CATransform3DMakeAffineTransform(t3);
//	leftArm.transform = CATransform3DMakeAffineTransform(CGAffineTransformScale(CGAffineTransformRotate(CGAffineTransformMakeTranslation(70.00, 0.35), M_PI), 1.00, 1.00));
	...
	t1 = CGAffineTransformMakeTranslation(-10.00, -231.625092);
	t2 = CGAffineTransformRotate(t1,  -1.221730);
	t3 = CGAffineTransformScale(t2, 1.00, 1.00);
	rightForArm.transform = CATransform3DMakeAffineTransform(t3);
//	rightForArm.transform = CATransform3DMakeAffineTransform(CGAffineTransformScale(CGAffineTransformRotate(CGAffineTransformMakeTranslation(-10.00, -231.625092), -1.221730), 1.00, 1.00));
	...
	t1 = CGAffineTransformMakeTranslation(-70.00, 0.00);
	t2 = CGAffineTransformRotate(t1,  0.0);
	t3 = CGAffineTransformScale(t2, 1.00, 1.00);
	rightArm.transform = CATransform3DMakeAffineTransform(t3);
//	rightArm.transform = CATransform3DMakeAffineTransform(CGAffineTransformScale(CGAffineTransformRotate(CGAffineTransformMakeTranslation(-70.00, 0.00), 0.00), 1.00, 1.00));
	...
	t1 = CGAffineTransformMakeTranslation(-5.00, -107.00);
	t2 = CGAffineTransformRotate(t1,  -M_PI_2);
	t3 = CGAffineTransformScale(t2, 1.00, 1.00);
	leftThigh.transform = CATransform3DMakeAffineTransform(t3);
//	leftThigh.transform = CATransform3DMakeAffineTransform(CGAffineTransformScale(CGAffineTransformRotate(CGAffineTransformMakeTranslation(-5.00, -107.00), -M_PI_2), 1.00, 1.00));
	...
	t2 = CGAffineTransformRotate(t1,  0.0);
	t3 = CGAffineTransformScale(t2, 1.00, 1.00);
	leftLeg.transform = CATransform3DMakeAffineTransform(t3);
//	leftLeg.transform = CATransform3DMakeAffineTransform(CGAffineTransformScale(CGAffineTransformRotate(CGAffineTransformMakeTranslation(-70.00, 0.00), 0.00), 1.00, 1.00));
	...
	t1 = CGAffineTransformMakeTranslation(-74.625122, 0.009674);
	t2 = CGAffineTransformRotate(t1,  -M_PI_2);
	t3 = CGAffineTransformScale(t2, 1.00, 1.00);
//	leftFoot.transform = CATransform3DMakeAffineTransform(t3);
	...
	t1 = CGAffineTransformMakeTranslation(5.00, -107.00);
	t2 = CGAffineTransformRotate(t1,  -2.617994);
	t3 = CGAffineTransformScale(t2, 1.00, 1.00);
	rightThigh.bounds = CGRectMake(0.00, 0.00, 74.00, 24.00);
	rightThigh.anchorPoint = CGPointMake(1.00, 0.50);
	rightThigh.transform = CATransform3DMakeAffineTransform(t3);
//	rightThigh.transform = CATransform3DMakeAffineTransform(CGAffineTransformScale(CGAffineTransformRotate(CGAffineTransformMakeTranslation(5.00, -107.00), -2.617994), 1.00, 1.00));
	...
	t1 = CGAffineTransformMakeTranslation(-69.712799, 0.24);
	t2 = CGAffineTransformRotate(t1,  M_PI_2);
	t3 = CGAffineTransformScale(t2, 1.00, 1.00);
	rightLeg.transform = CATransform3DMakeAffineTransform(t3);
//	rightLeg.transform = CATransform3DMakeAffineTransform(CGAffineTransformScale(CGAffineTransformRotate(CGAffineTransformMakeTranslation(-69.712799, 0.24), M_PI_2), 1.00, 1.00));
	...
	t1 = CGAffineTransformMakeTranslation(-75.00, 0.00);
	t2 = CGAffineTransformRotate(t1,  -M_PI_2);
	t3 = CGAffineTransformScale(t2, 1.00, 1.00);
	rightFoot.transform = CATransform3DMakeAffineTransform(t3);
	...
	t1 = CGAffineTransformMakeTranslation(0.00, 0.00);
	t2 = CGAffineTransformRotate(t1,  0.0);
	t3 = CGAffineTransformScale(t2, 2.50, 2.50);
	BckScene.transform = CATransform3DMakeAffineTransform(t3);
	...
	t1 = CGAffineTransformMakeTranslation(0.00, 460.00);
	t2 = CGAffineTransformRotate(t1,  0.0);
	t3 = CGAffineTransformScale(t2, 1.00, 1.00);
	sideWalk.transform = CATransform3DMakeAffineTransform(t3);
	...
	NSDictionary *scene = [NSDictionary dictionaryWithObjectsAndKeys:  Empty_,		@"Empty",
																	   ...
																	   neck,		@"Plane__002",
																	   head,		@"Plane__005",
																	   leftForArm,	@"Plane__003",
																	   leftArm,		@"Plane__007",
																	   rightForArm,	@"Plane__004",
																	   rightArm,	@"Plane__006",
																	   leftThigh,	@"Plane__008",
																	   leftLeg,		@"Plane__011",
																	   leftFoot,	@"Plane__013",
																	   rightThigh,	@"Plane__009",
																	   rightLeg,	@"Plane__010",
																	   rightFoot,	@"Plane__012",
																	   BckScene,	@"Plane__001",
																	   sideWalk,	@"Plane__014",nil];
	return scene;
}
...
- (NSDictionary*)makeAnimTracks
{
	...
	NSDictionary *anims = [NSDictionary dictionaryWithObjectsAndKeys:  Plane_anim,@"Plane",
																	   Plane__002_anim,@"Plane__002",
																	   Plane__003_anim,@"Plane__003",
																	   Plane__007_anim,@"Plane__007",
																	   Plane__004_anim,@"Plane__004",
																	   Plane__006_anim,@"Plane__006",
																	   Plane__008_anim,@"Plane__008",
																	   Plane__011_anim,@"Plane__011",
																	   Plane__013_anim,@"Plane__013",
																	   Plane__009_anim,@"Plane__009",
																	   Plane__010_anim,@"Plane__010",
																	   Plane__012_anim,@"Plane__012",nil];
	return anims;
}
