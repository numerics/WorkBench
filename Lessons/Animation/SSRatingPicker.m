...
NSString *const kSSToolkitBundleName = @"WorkBench.bundle";
...
- (void)_initialize
{
	...
	self.emptyStarImage = [UIImage imageNamed:@"gray-star.png"];
	self.filledStarImage = [UIImage imageNamed:@"orange-star.png"];
...
- (void)_setSelectedNumberOfStarsWithTouch:(UITouch *)touch
{
	...
	CGFloat totalWidth = (_starSize.width * (CGFloat)_totalNumberOfStars) +  (_starSpacing * (CGFloat)(_totalNumberOfStars - 1));
