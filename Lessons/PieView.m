...
#define kSizeRatio				0.75 //Tanoi-011210
...
- (void)drawRect:(CGRect)rect
{
	...
	for (int i = 0; i < n_items; i++)
	{
		...
		else
		{
			...
			CGFloat pieceCenterAngle = startAngle - pieceAngle / 2.0;
			CGFloat pieceRadius = kInnerCircleRadius + (radius - kInnerCircleRadius) / 2.0;
			CGSize titleSize = [item.title sizeWithAttributes: @{NSFontAttributeName: font}];
			...
			[txt drawAtPoint:CGPointMake(labelCenter.x - titleSize.width / 2.0, labelCenter.y - titleSize.height / 2.0) withAttributes:@{NSFontAttributeName: font}];
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
	...
	CGContextSaveGState(context);
	CGRect innerRect = CGRectMake(center.x - kInnerCircleRadius, center.y - kInnerCircleRadius, kInnerCircleRadius * 2.0, kInnerCircleRadius * 2.0);
	CGContextAddEllipseInRect(context, innerRect); //Tanoi-011510, will use innerRect to fill circle with color passed
												   //CGContextAddEllipseInRect(context, CGRectMake(center.x - kInnerCircleRadius, center.y - kInnerCircleRadius, kInnerCircleRadius * 2.0, kInnerCircleRadius * 2.0));
	CGContextClip(context);
	
	if(myColor != nil) //Tanoi-011510 - Change background color
	{
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
	...
	CGRect inneRect = CGRectMake(center.x - kRoundedRectRadius, center.y - kRoundedRectRadius, kRoundedRectRadius * 2.0, kRoundedRectRadius * 2.0);//Tanoi-011210
